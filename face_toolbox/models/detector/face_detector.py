...
class MTCNNFaceDetector(BaseFaceDetector):
    def __init__(self,
        weights_path=pkg_resources.resource_filename('face_toolbox', 'models/detector/mtcnn')):
...
class S3FaceDetector(BaseFaceDetector):
    def __init__(self,
        weights_path=pkg_resources.resource_filename('face_toolbox', 'models/detector/s3fd/s3fd_keras_weights.h5')):
...
class FaceAlignmentDetector(BaseFaceDetector):
    def __init__(self,
        fd_weights_path=pkg_resources.resource_filename('face_toolbox', 'models/detector/s3fd/s3fd_keras_weights.h5'),
        lmd_weights_path=pkg_resources.resource_filename('face_toolbox', 'models/detector/FAN/2DFAN-4_keras.h5'),
        fd_type='s3fd'):
